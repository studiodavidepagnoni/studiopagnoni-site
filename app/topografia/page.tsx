...
export const metadata: Metadata = {
  title: "Topografia e rilievi planoaltimetrici — Brescia, Franciacorta, Lombardia",
  description:
    "Rilievi topografici professionali con GNSS RTK e stazione totale: planimetrie quotate, volumetrie, cantieri e frazionamenti. Studio Tecnico Pagnoni a Bornato (Cazzago San Martino, Brescia).",
